...
QUY ĐỊNH BẮT BUỘC VỀ VĂN PHONG & ĐỘ DÀI NHẬN XÉT:
- BẮT BUỘC NGẮN GỌN & SÚC TÍCH: Để gói gọn phiếu nhận xét đánh giá trong vòng KHÔNG QUÁ 2 TRANG GIẤY khi in PDF hoặc xuất Word, tất cả các câu nhận xét, phân tích, ưu nhược điểm phải thật ngắn gọn, đi thẳng vào trọng tâm chuyên môn, tránh viết dông dài hoa mỹ.
- Mỗi tiêu chí (suCanThiet, tinhMoi, giaiPhap, hieuQua, khaNangApDung) chỉ nhận xét tối đa 2-3 ý ngắn gọn (mỗi ý không quá 1-2 dòng ngắn).
- Các mảng uuDiem, hanChe, improvements ở cuối cũng chỉ cần tối đa 2-3 ý cô đọng, sắc sảo nhất.
- BẮT BUỘC TÁCH Ý NHỎ: Các mảng nhận xét (analysis, pros, cons) bắt buộc phải tách ý nhỏ. Tức là mỗi ý tưởng / mỗi câu nhận xét nên là 1 phần tử riêng biệt trong Array. KHÔNG viết một đoạn văn dài gộp nhiều câu và nhiều dấu chấm (.) vào 1 phần tử Array duy nhất. Hãy chia nhỏ ra để xuống dòng hợp lý.
...
- CHỈ ĐÁNH DẤU LÀ ĐẠO VĂN NẾU PHÁT HIỆN SỰ TRÙNG LẶP LIÊN TỤC VÀ KÉO DÀI. TUYỆT ĐỐI KHÔNG TÍNH ĐẠO VĂN đối với các đoạn ngắn (như dưới 7-8 dòng, hoặc dưới 100 từ) vì đây thường là ngôn ngữ chung, lý luận chung hoặc trích dẫn. Chỉ đánh dấu isDuplicate: true nếu đoạn sao chép nguyên văn liên tục từ 8 dòng trở lên, hoặc các khu vực có nội dung tương tự liên quan đến cùng một đường link có dấu hiệu đạo văn.
